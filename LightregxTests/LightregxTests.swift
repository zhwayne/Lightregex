...
class LightregxTests: XCTestCase {
    ...
    func testExample() {
        ...
        XCTAssertEqual(Lightregx("^1[3|4|5|6|7|8][0-9]\\d{4,8}$").match(in: "17012345678"), true)

        XCTAssertEqual(Lightregx("\\d").replace(in: "abc12ded7t8asdf45gsg", apply: { (str) -> String in
            return "\((Int(str) ?? 0) * 2)"
